...
export class Backend implements backendInterface {
    ...
    async addOrUpdateTruckStop(arg0: bigint | null, arg1: string, arg2: string, arg3: string, arg4: string, arg5: string, arg6: bigint): Promise<bigint> {
        if (this.processError) {
            try {
                const result = await this.actor.addOrUpdateTruckStop(to_candid_opt_n1(this._uploadFile, this._downloadFile, arg0), arg1, arg2, arg3, arg4, arg5, arg6);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getAllTruckStops(): Promise<Array<TruckStop>> {
        if (this.processError) {
            try {
                const result = await this.actor.getAllTruckStops();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getTruckStopById(arg0: bigint): Promise<TruckStop> {
        if (this.processError) {
            try {
                const result = await this.actor.getTruckStopById(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async removeTruckStop(arg0: bigint): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.removeTruckStop(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async searchTruckStops(arg0: string): Promise<Array<TruckStop>> {
        if (this.processError) {
            try {
                const result = await this.actor.searchTruckStops(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async updateShowerAvailability(arg0: bigint, arg1: bigint): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.updateShowerAvailability(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
